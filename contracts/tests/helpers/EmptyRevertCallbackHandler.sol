...
/**
 * @dev Test helper that reverts with no reason data, exercising the empty-reason branch
 * in CallbackProcessorDataObject._onCallbackHandlerFailure.
 */
contract EmptyRevertCallbackHandler is IDataObjectCallbackHandler, ERC165 {
